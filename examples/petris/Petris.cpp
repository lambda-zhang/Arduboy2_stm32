...
#else
  constexpr uint8 GetIndex(uint8 x, uint8 y) const { return x + (y * k_gridWidth); }
#endif /* STM32F103xB */
...
#else
  constexpr uint8 GetNumRotationOffsets() const { return k_numAlternateRotationOffsets + 1; }
#endif /* STM32F103xB */
