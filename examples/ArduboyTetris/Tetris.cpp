...
static unsigned char board[(BOARD_HEIGHT * BOARD_WIDTH / 8) + 1]; //Board is a continuous array of bits

static const int BOARD_X = 25;
static const int BOARD_Y = 2;
static const int CELL_SIZE = 3;

static const int INIT_DROP_DELAY = 60; // delay in frames
static const int MOVE_DELAY = 8;
static const int FASTEST_LEVEL = 10;
static int dropDelay;
static int dropTimer;
static int moveTimer;

static const int MAX_GAME_OVER_DELAY = 30;
