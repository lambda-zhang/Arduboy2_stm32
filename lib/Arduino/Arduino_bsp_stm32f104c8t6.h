...
#define LCDBOOTPROGRAMARR                                                                                              \
	0xAE, /* set display display ON/OFF,AFH/AEH */                                                                 \
		0x02, 0x10, 0x40, /* set display start line:COM0 */                                                    \
		0xB0, 0x81, /* set contrast control */                                                                 \
		0xCF, 0xA1, /* entire display on: A4H:OFF/A5H:ON */                                                    \
		0xC8, /* 该指令控制显示方向显示方向0xc8或者0xc0 */                                      \
		0xAF, 0xA7, /* set normal/inverse display: A6H:normal/A7H:inverse */                                   \
		...
		0x22, 0xDA, /* Common Pads Hardware Configuration Mode Set */                                          \
		0x12, 0xDB, /* set vcomh deselect level */                                                             \
		0x40, /* VCOM = β X VREF = (0.430 + A[7:0] X 0.006415) X VREF */                                      \
		0xA4, 0xA6, 0xAF /* set display display ON/OFF,AEH/AFH */
